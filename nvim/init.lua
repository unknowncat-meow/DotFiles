...
-- dont need plugin manager cause we have lazy
-- require('plugins')

-- NOTE: Here is where you install your plugins.
--  You can configure plugins using the `config` key.

-- formart on save with prettier and null-ls
...
-- format file on save with prettier and lsp
...
-- insert '(' after selecting the function in cmp
...
-- setting up copy paste shortcuts
-- for pasting in visual mode and normal mode
vim.keymap.set('n', 'cv', '"+p', { noremap = true })
vim.keymap.set('v', 'cv', '"+p', { noremap = true })

-- for copying-cutting current line in normal mode
vim.keymap.set('n', 'cc', 'yy', { noremap = true })
vim.keymap.set('n', 'cx', 'dd', { noremap = true })
-- for copying-cutting current selection if has any in visual mode
vim.keymap.set('v', 'cc', '"*y', { noremap = true })
